            ...
            <form id="create_post" action="{{route('store.post')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12 col-md-8">
                        <div class="add_form">
                            <div class="mb-4">
                                <label class="text-black" for="post_title">Post Title</label>
                                <input type="text" name="post_title" id="post_title" value="{{old('post_title')}}">
                                <span class="error-message d-block text-black"></span>
                            </div>
                            <div>
                                <label class="text-black" for="post_desc">post Description</label>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="add-tags">
                            <h4 class=" text-black">Tags</h4>
                            <div class="_box">
                                <label for="tagList" class=" text-black">Add tag (Press ENTER to Add new Tag)</label>
                                <input type="hidden" id="Tags" name="post_tags" />
                                <input type="text" id="newTag" class="newTag" />
                                <ul id="tagList" class="tagList tagList--admin">
                                    <!-- All TagList Here! -->
                                </ul>  
                            </div>
                        </div>
                        <div class="mb-4">
                            <h4 class=" text-black">Post Thumbnail</h4>
